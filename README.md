...
New features added:
1. Publish of the complete odometry message (added velocity);
2. Added function ``` compute_metrics ``` where Fisher information matrix is computed (it doesn't work with livox lidars);
3. Included topic publication of number of tracked points and state-error covariance trace;
